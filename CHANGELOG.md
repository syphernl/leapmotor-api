...
- Added B11 → C10 status path mapping (B11 shares the C10 status endpoint, like B10)- Added permission reference table to `docs/api.md` mapping each `VehicleRight` to its corresponding remote command
