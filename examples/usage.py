...
def main() -> None:
    ...
    try:
        ...
        for vehicle in vehicles:
            ...
            print(f"    Schedule enabled:       {vs.battery.charge_schedule_enabled}")
            print(f"    Schedule start:         {vs.battery.charge_schedule_start}")
            print(f"    Schedule end:           {vs.battery.charge_schedule_end}")
            print(f"    Schedule cycles:        {vs.battery.charge_schedule_cycles}")
            print(f"    Schedule circulation:   {vs.battery.charge_schedule_circulation}")
